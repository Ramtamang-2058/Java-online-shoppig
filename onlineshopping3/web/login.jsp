                ...
                <div class="container">
                    <div class="signin-content">
                        ...
                        <div class="signin-form">
                            <h2 class="form-title" style="font-family: Poppins">Log In</h2>
                            <form method="post" action="Login" class="register-form"
                                ...
                                <a style="font-size: 12px" class="ml-auto border-link small-xl" href="forgotPassword.jsp">Forgot Password?</a>
